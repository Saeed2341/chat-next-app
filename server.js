...
const { parse } = require("url"); // ← این خط رو اضافه کن
...
app.prepare().then(async () => {
  ...
  const server = createServer((req, res) => {
    // ✅ این خط حیاتی است - درخواست رو با parsedUrl به Next.js بفرست
